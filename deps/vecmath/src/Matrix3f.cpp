...
Matrix3f& Matrix3f::invert(bool *pbIsSingular, double epsilon) {
    double m00 = m_elements[ 0 ];
    double m10 = m_elements[ 1 ];
    double m20 = m_elements[ 2 ];
    ...
    else
    {
        ...
        m_elements[ 0 ] = cofactor00 * reciprocalDeterminant;
        m_elements[ 1 ] = cofactor01 * reciprocalDeterminant;
        m_elements[ 2 ] = cofactor02 * reciprocalDeterminant;
        m_elements[ 3 ] = cofactor10 * reciprocalDeterminant;
        m_elements[ 4 ] = cofactor11 * reciprocalDeterminant;
        m_elements[ 5 ] = cofactor12 * reciprocalDeterminant;
        m_elements[ 6 ] = cofactor20 * reciprocalDeterminant;
        m_elements[ 7 ] = cofactor21 * reciprocalDeterminant;
        m_elements[ 8 ] = cofactor22 * reciprocalDeterminant;
    }
    return *this;
}
